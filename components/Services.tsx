    ...
    <section id={SectionId.SERVICES} className="py-24 bg-brand-dark relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#1e293b]/30 border border-white/5 p-8 rounded-3xl hover:border-brand-primary/50 transition-all group">
            ...
            <div className="bg-[#1e293b]/30 border border-white/5 p-8 rounded-3xl hover:border-brand-accent/50 transition-all group border-b-4 border-b-brand-accent">
