          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            {planType === 'me' && (
              <div className="bg-[#1e293b]/50 p-6 md:p-8 rounded-2xl border border-white/10 animate-fadeIn">
                <h3 className="text-base md:text-xl font-bold text-white mb-6 md:mb-8 flex items-center gap-2"><Calculator className="w-5 h-5 text-brand-primary" /> Faturamento Mensal</h3>
                <input type="range" min="0" max="300000" step="5000" value={revenue} onChange={e => setRevenue(Number(e.target.value))} className="w-full h-4 md:h-3 bg-[#0f172a] rounded-lg accent-brand-primary cursor-pointer touch-none" />
