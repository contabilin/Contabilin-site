        ...
        <section id={SectionId.DASHBOARD} className="py-24 bg-brand-dark relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="relative group max-w-6xl mx-auto">
                    ...
                    <div className="bg-[#0b0f1a] rounded-[2rem] border border-white/10 shadow-2xl overflow-hidden p-3 md:p-8 flex flex-col gap-6">

                        {/* Header: Empresa info */}
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-[#161d2b] p-4 md:p-6 rounded-2xl border border-white/5">
                    ...
                    <div className="absolute -bottom-4 -right-4 md:-bottom-6 md:-right-6 md:right-8 bg-[#25D366] text-white p-3 md:p-4 rounded-full shadow-2xl animate-float-slow z-20 cursor-pointer hover:scale-110 transition-transform">
